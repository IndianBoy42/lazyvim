  ...
  opts = {
    ...
    callbacks = {
      ...
      should_block = function(argv)
        ...
        if vim.tbl_contains(argv, "DiffEditor") then
          return true
        end
        if vim.tbl_contains(argv, "JJDiffConflicts") then
          return true
        end
        if vim.tbl_contains(argv, "JJDiffConflicts!") then
          return true
      ...
      should_nest = function(host)
        ...
        if vim.tbl_contains(vim.v.argv, "--focus") then
          return false
        end

        if vim.tbl_contains(vim.v.argv, "DiffEditor") then
          return true
        end
        if vim.tbl_contains(vim.v.argv, "JJDiffConflicts") then
          return true
        end
        if vim.tbl_contains(vim.v.argv, "JJDiffConflicts!") then
          return true
